...
\fancyheadoffset[L]{30pt}
\footskip = 15pt
%\voffset=-3.5in
%\fancyhead[LE,RO]{\slshape \rightmark}
\fancyhead{} %Clear all headers
%\fancyhead[LO]{\slshape \leftmark}
\fancyhead[R]{\bfseries Bpel to Java}

\lhead{\setlength{\unitlength}{1mm}
\begin{picture}(0,0)
\put(0,0){\includegraphics[width=60mm]{pictures/Logo.png}}
\end{picture}}
...
\input{introduction}
\input{ServiceOrientedComputing}
\input{ModelDrivenApproaches}
\input{MethodologicalApproach}
\input{DetailedArchitecture}
\input{Discussion}
\input{Conclusion}
% 
% \input{Comparison}
